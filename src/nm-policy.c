...
static void settings_set_hostname_cb (const char *hostname, gboolean result)
{
	int ret = 0;
...
set_system_hostname (NMPolicy *self, const char *new_hostname, const char *msg)
{
	...
	nm_settings_set_transient_hostname (priv->settings, name, settings_set_hostname_cb);
}
